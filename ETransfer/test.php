...
<body>
    ...
    <div class="container">
            ...
            <div class="grid-2">
                <div class="form-group">
                    ...
                    <input type="number" id="o2_pressure" class="calc-input" placeholder="เช่น 1500"
                        oninput="calculateOxygen()">
                    <small style="color: var(--text-muted); font-size: 0.75rem;">*หักลบ Safe residual pressure 200 PSI
                        โดยอัตโนมัติ</small>
                </div>
                <div class="form-group">
        ...
        <div class="card" style="margin-bottom: 2rem;">
            ...
            <button type="button" onclick="window.print()" class="evaluate-btn" style="background-color: var(--success); display: flex; align-items: center; justify-content: center; gap: 0.5rem;">
    ...
    <script>
        ...
        function calculateOxygen() {
            ...
            const flowRate = parseFloat(document.getElementById('o2_flow_rate').value);
            ...
            // Need valid numbers to calculate
            if (isNaN(pressure) || isNaN(flowRate) || isNaN(factor) || flowRate <= 0) {
                resultBanner.style.display = 'none';
                return;
            }

            // Safe residual pressure usually 200 psi
            const safePressure = Math.max(0, pressure - 200);

            // Time = (Pressure * Factor) / FlowRate
            const totalMinutes = (safePressure * factor) / flowRate;
        ...
        document.getElementById('o2_type').addEventListener('change', updateSection6Sync);
