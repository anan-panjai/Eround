...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;font-family:'IBM Plex Sans Thai','Inter',sans-serif;}
        ...
        .stepper{display:flex;justify-content:center;max-width:780px;margin:0 auto;overflow-x:auto;scrollbar-width:none;}
        .stepper::-webkit-scrollbar{display:none;}
        .step-item{display:flex;flex-direction:column;align-items:center;gap:.25rem;padding:.7rem 1.25rem;cursor:pointer;border-bottom:3px solid transparent;transition:var(--transition);min-width:90px;}
        .step-item:hover{background:#f0f6ff;}
        .step-item.active{border-bottom-color:var(--med-600);}
        .step-dot{width:28px;height:28px;border-radius:50%;border:2px solid var(--border);display:flex;align-items:center;justify-content:center;font-size:.75rem;font-weight:700;color:var(--muted);background:#fff;transition:var(--transition);}
        ...
        .step-label{font-size:.65rem;font-weight:600;color:var(--muted);text-align:center;line-height:1.3;}
        ...
        @media print{.hero,.stepper-wrap,.evaluate-btn,.ai-btn{display:none!important;}}
    </style>
</head>
